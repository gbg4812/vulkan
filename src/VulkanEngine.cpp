...
uint32_t VulkanEngine::deviceScore(VkPhysicalDevice device) {
    ...
    if (indices.isComplete() and checkDeviceExtensionSupport(device)) {
        SwapChainSupportDetails swapChainDetails =
            ...
            if (pmodesCount != 0) {
                ...
                vkGetPhysicalDeviceSurfacePresentModesKHR(
                    device, surface, &pmodesCount, details.presentModes.data());
            }
        ...
        void VulkanEngine::generateMipmaps(VkImage image, VkFormat format,
            ...
            endSingleTimeCommands(commandBuffer, graphicsCmdPool,
                                  graphicsQueue);
        }
        ...
        void VulkanEngine::transitionImageLayout(
            ...
            vkCmdPipelineBarrier(transBuffer, srcStage, dstStage, 0, 0, nullptr,
                                 0, nullptr, 1, &barrier);
        ...
        void VulkanEngine::copyBufferToImage(VkBuffer buffer, VkImage image,
            ...
            endSingleTimeCommands(commandBuffer, transferCmdPool,
                                  transferQueue);
        }
        ...
        void VulkanEngine::createTextureSampler() {
            ...
            if (vkCreateSampler(device, &createInfo, nullptr,
        ...
        void VulkanEngine::createVertexBuffers() {
            ...
            for (size_t i = 0; i < objects.size(); ++i) {
                VkDeviceSize size =
                    objects[i]->getVertexSize() * sizeof(Vertex);
                ...
                vertexBuffers[i] =
                    vk_Buffer(device, physicalDevice, size,
        ...
        void VulkanEngine::createIndexBuffers() {
            ...
            for (size_t i = 0; i < objects.size(); ++i) {
                VkDeviceSize size =
                    objects[i]->getIndexSize() * sizeof(uint32_t);
        ...
        void VulkanEngine::recordCommandBuffer(VkCommandBuffer commandBuffer,
            ...
            for (int i = 0; i < vertexBuffers.size(); ++i) {
                ...
                vkCmdPushConstants(
                    ...
                    0, sizeof(glm::mat4), objects[i]->getModelMatrix());

                vkCmdDrawIndexed(commandBuffer, objects[i]->getIndexSize(), 1,
                                 0, 0, 0);
            }
